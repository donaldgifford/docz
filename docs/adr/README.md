...
| ADR-0004 | One repository: docz, docz-api, and docz-site as a single Go module | Proposed | 2026-09-21 | Donald Gifford | [0004-one-repository-docz-docz-api-and-docz-site-as-a-single-go-module.md](0004-one-repository-docz-docz-api-and-docz-site-as-a-single-go-module.md) |
