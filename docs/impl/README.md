...
| IMPL-0018 | v2.0.0-beta.1 — the docz API as one unit, structured regions, and the cmd swap | Draft | 2026-09-19 | Donald Gifford | [0018-v200-beta1-the-docz-api-as-one-unit-structured-regions-and-the.md](0018-v200-beta1-the-docz-api-as-one-unit-structured-regions-and-the.md) |
